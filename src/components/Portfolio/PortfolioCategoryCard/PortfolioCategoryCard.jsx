...
export default function PortfolioCategoryCard({
  ...
  return (
    <Link href={hrefLink}>
      <div className="group w-full h-full relative flex flex-col gap-2 lg:gap-y-4 p-4 lg:p-6 bg-zinc-50  shadow-xl shadow-slate-400 hover:shadow-slate-500 transition-shadow">
        {/* <div
